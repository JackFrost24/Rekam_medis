  ...
  <div class="min-h-full">
            ...
            <div class="flex items-center">
              <div class="shrink-0">
                <a href="{{ url('dashboard') }}">
                  <img src="{{ asset('images/logo.png') }}" alt="Logo" width="90">
                </a>
              </div>
    ...
    <header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Pasien</h1>
      </div>
    </header>
    <main>
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <div class="p-6">
          ...
          <div class="mb-4 flex items-center space-x-2">
            ...
            >
            <button class="searchButton flex-shrink-0">Cari Pasien</button>
            <a href="addpasien" class="myButton flex-shrink-0">Tambah Pasien</a>
          </div>
